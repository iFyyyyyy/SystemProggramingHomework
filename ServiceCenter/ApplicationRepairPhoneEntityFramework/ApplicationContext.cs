    ...
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Employee>().HasData(
                new Employee { ID_Employee = "qwe", Password = "qwe", 
                FIO = "Фефилов Илья Сергеевич", ID_Position = 5, Series_Number_Password = "0000 000000", Address = "Воронеж", 
                Phone_Number = "+79204479929", EmploymentDate = DateTime.Now });
        ...
        {
            optionsBuilder.UseSqlServer(@"Server="+ ServerClass.Server +";Database=ServiceCenter;Trusted_Connection=True;TrustServerCertificate=true;");
        }
